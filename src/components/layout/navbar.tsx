...
const nav = [
  ...
  { href: "/services", label: "Вет/Груминг" },
    ...
    <header className="sticky top-0 z-50 border-b border-white/60 bg-white/75 shadow-sm shadow-emerald-900/5 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            className="hidden rounded-xl p-2 text-stone-500 transition hover:bg-stone-100 hover:text-emerald-700 sm:block"
            ...
            <div className="flex flex-col gap-1 px-4 py-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-stone-500">{currentUser.city}</p>
                </div>
              </Link>
            </div>
          </motion.nav>
