/**
 * Загрузка изображений в public/uploads: валидация MIME/размера и удаление файлов.
 */
 ...
 * @param file File из формы
 * @returns Сообщение об ошибке или null, если файл допустим
 */
...
/**
 * Очищает имя папки от небезопасных символов.
 * @param folder Имя подпапки
 * @returns Безопасный префикс до 32 символов
 */
...
/**
 * Генерирует уникальное имя файла с префиксом папки и timestamp.
 * @param file Исходный File
 * @param folder Логическая папка (avatars, products и т.д.)
...
/**
 * Сохраняет изображение в public/uploads и возвращает публичный URL.
 * @param file Файл изображения
 * @param folder Префикс имени файла (по умолчанию uploads)
 * @returns url (/uploads/...) и pathname (uploads/...)
...
/**
 * Удаляет файл из public/uploads по pathname.
 * @param pathname Относительный путь uploads/... или /uploads/...
 */
